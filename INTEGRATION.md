...
This specifies that Carthage use the latest version of MBEventHandling that is API-compatible with 3.0.0, i.e. any 3.0.*x* version.

**Note:** Be sure to check the [latest releases](https://github.com/emaloney/MBEventHandling/releases); there may be a newer version than 3.0.0 that is no longer API-compatible.
